...
const Wizard = () => {
    ...
    return (
        <div className="grid grid-cols-[1fr_2fr]">
            ...
            <div className="h-[300px] bg-slate-400">

            </div>
            <div className="h-[300px] bg-slate-200 p-3">
                Selected Interests Box
                <div className="px-3 bg-slate-50 py-3"></div>
                Interests List Box
                <div className="px-3 flex flex-wrap bg-slate-50 py-3">
                    {interests.map((item, i) => (
                        <div key={i} className="py-1 px-3 m-1 rounded-xl cursor-pointer bg-orange-200 hover:bg-orange-300">
                            {item.name}
